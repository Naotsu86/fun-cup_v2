export const avatarOptions = {
  ...
  headItem: [
    ...
    { id: 'cap_black', label: 'Schwarze Mütze', file: 'head_cap_black.png', unlocked: true },
    { id: 'cap_blue', label: 'Blaue Mütze', file: 'head_cap_blue.png', unlocked: true },
    { id: 'cap_navy', label: 'Navy Mütze', file: 'head_cap_navy.png', unlocked: true },
    { id: 'cap_teal', label: 'Türkis Mütze', file: 'head_cap_teal.png', unlocked: true },
    { id: 'cap_green', label: 'Grüne Mütze', file: 'head_cap_green.png', unlocked: true },
    { id: 'cap_lime', label: 'Lime Mütze', file: 'head_cap_lime.png', unlocked: true },
    { id: 'cap_yellow', label: 'Gelbe Mütze', file: 'head_cap_yellow.png', unlocked: true },
    { id: 'cap_orange', label: 'Orange Mütze', file: 'head_cap_orange.png', unlocked: true },
    { id: 'cap_red', label: 'Rote Mütze', file: 'head_cap_red.png', unlocked: true },
    { id: 'cap_pink', label: 'Pink Mütze', file: 'head_cap_pink.png', unlocked: true },
    { id: 'cap_purple', label: 'Lila Mütze', file: 'head_cap_purple.png', unlocked: true },
    { id: 'cap_brown', label: 'Braune Mütze', file: 'head_cap_brown.png', unlocked: true },
    { id: 'cap_gray', label: 'Graue Mütze', file: 'head_cap_gray.png', unlocked: true }
  ],
